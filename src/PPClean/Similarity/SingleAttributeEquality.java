...
public class SingleAttributeEquality implements RecordSimilarity {
    ...
    public double compare(Record r1, Record r2) {
        ...
        if(r1.getContent().size() != r2.getContent().size()){
            throw new IllegalArgumentException("Die Objekte r1 und r2 sind nicht miteinander vergleichbar.");
        }
        if(attributeIndex > r1.getContent().size()){
            throw new IllegalArgumentException("Der Attribut Index ist \"Out of Bounds \".");
        }
